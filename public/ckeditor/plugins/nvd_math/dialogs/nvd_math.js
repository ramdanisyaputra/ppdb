		...
		contents: [
			{
				...
				elements:
					...
					(!(CKEDITOR.env.ie && CKEDITOR.env.version === 8)) && {
						...
						type: 'html',
						html:
							'<div class = "nvd-math-prw" style="text-align:center;margin-top:200px;">' +
					...
					},
					{
						//this element for embed toolbar
						type: 'html',
						html: '<label class="ppr-whn-ld-dn">Klik kotak dibawah ini terlebih dahulu sebelum klik simbol matematika</div>',
					},
