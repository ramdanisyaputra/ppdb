    ...
    <div class="page-inner">
        ...
        <div class="card">
            ...
            <div class="card-body" id="cetak">
                ...
                <p style="margin-bottom:0.0000pt;text-align:justify;line-height:150%;"><span style="font-family:'Times New Roman';line-height:150%;font-size:16px;">Masuk tahun pelajaran</span><span style="font-family:'Times New Roman';line-height:150%;font-size:16px;">: &nbsp;{{$pernyataan->peserta->profil->tahunAjaran->nama}}</span></p>
