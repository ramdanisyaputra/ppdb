                    ...
                    <div class="col-md-8">
                        <form action="{{ route('tes.soal.store', $tes->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="soal" id="soal" cols="30" rows="5" class="form-control ckeditor @error('soal') is-invalid @enderror" required>{!! old('soal') !!}</textarea>
                                @error('soal')
...
<script>
    ...
    function initCkeditor(id) {
        ...
        CKEDITOR.replace(id, {
            extraPlugins: 'uploadimage,image2,ckeditor_wiris,nvd_math',
...
<script>
    ...
    var pg = `<div class="form-group pg">
